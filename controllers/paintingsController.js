...
const Product = require('../models/paintingProductModel');
const fs = require('fs');
...
const listProducts = async (req, res) => {
  try {
    ...
    res.render('paintingProduct/index', { products });
  } catch (error) {
...
const renderCreateForm = (req, res) => {
  res.render('paintingProduct/create');
};
...
const createProduct = async (req, res) => {
  try {
    ...
    const imagePath1 = 'paintinguploads/' + image1.name;
    const imagePath2 = 'paintinguploads/' + image2.name;
    ...
    res.redirect('/admin/paintingProduct');
  } catch (error) {
...
const renderEditForm = async (req, res) => {
  try {
    ...
    res.render('paintingProduct/edit', { product });
  } catch (error) {
...
const renderDeleteForm = async (req, res) => {
  try {
    ...
    res.render('paintingProduct/delete', { product });
  } catch (error) {
