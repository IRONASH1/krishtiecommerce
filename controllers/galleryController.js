...
const Product = require('../models/galleryProductModel');
const fs = require('fs');
...
const listProducts = async (req, res) => {
  try {
    ...
    res.render('galleryProduct/index', { products });
  } catch (error) {
...
const renderCreateForm = (req, res) => {
  res.render('galleryProduct/create');
};
...
const createProduct = async (req, res) => {
  try {
    ...
    const imagePath1 = 'galleryuploads/' + image1.name;
    const imagePath2 = 'galleryuploads/' + image2.name;
    ...
    res.redirect('/admin/galleryProduct');
  } catch (error) {
...
const renderEditForm = async (req, res) => {
  try {
    ...
    res.render('galleryProduct/edit', { product });
  } catch (error) {
...
const renderDeleteForm = async (req, res) => {
  try {
    ...
    res.render('galleryProduct/delete', { product });
  } catch (error) {
